...
namespace Bookify.Services.Services
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendBookingCancellation(string toEmail, string userName, int bookingId)
        {
            try
            {
        ...
        public async Task SendBookingConfirmation(string toEmail, int bookingId, string userName, DateTime checkIn, DateTime checkOut, decimal totalAmount)
        {
            try
            {
        ...
        public async Task SendBookingPayment(string toEmail, string userName, int bookingId, decimal totalAmount)
        {
            try
            {
